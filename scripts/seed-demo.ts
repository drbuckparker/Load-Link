...
async function main() {
  ...
  try {
    ...
    add({ id: "demo-job-c09", contractor_id: "demo-main", driver_id: null, project_id: "demo-proj-1", material: "Fill Dirt", destination_address: "500 Capitol Mall, Sacramento, CA", rate: "87.00", rate_type: "hourly", truck_type: "tandem_dump", status: "open", scheduled_date: d(6), payment_status: "unpaid", trucks_needed: 1, total_tons_needed: "160.00", estimated_trips: 10 });
    ...
    add({ id: "demo-job-c14", contractor_id: "demo-main", driver_id: "demo-drv-1", project_id: "demo-proj-1", material: "Fill Dirt", destination_address: "500 Capitol Mall, Sacramento, CA", rate: "86.00", rate_type: "hourly", truck_type: "tandem_dump", status: "completed", scheduled_date: d(-10), completed_date: d(-10, 16), payment_status: "payment_sent", trucks_needed: 1, total_tons_needed: "170.00", estimated_trips: 11 });
    ...
    dadd({ id: "demo-job-d01", contractor_id: "demo-con-1", driver_id: "demo-main", material: "3/4 Crush", rate: "92.00", rate_type: "hourly", truck_type: "tri_axle", status: "completed", scheduled_date: d(-25), completed_date: d(-25, 16), payment_status: "payment_received", trucks_needed: 1, total_tons_needed: "190.00", estimated_trips: 10 });
    ...
    dadd({ id: "demo-job-d03", contractor_id: "demo-con-1", driver_id: "demo-main", material: "Base Rock", rate: "90.00", rate_type: "hourly", truck_type: "tri_axle", status: "completed", scheduled_date: d(-12), completed_date: d(-12, 17), payment_status: "payment_sent", trucks_needed: 1, total_tons_needed: "175.00", estimated_trips: 11 });
    ...
    dadd({ id: "demo-job-d05", contractor_id: "demo-con-2", driver_id: "demo-main", material: "Asphalt Millings", rate: "94.00", rate_type: "hourly", truck_type: "tri_axle", status: "in_progress", scheduled_date: d(0, 6), payment_status: "unpaid", trucks_needed: 1, total_tons_needed: "180.00", estimated_trips: 9 });
    dadd({ id: "demo-job-d06", contractor_id: "demo-con-1", driver_id: "demo-main", material: "3/4 Crush", rate: "91.00", rate_type: "hourly", truck_type: "tri_axle", status: "accepted", scheduled_date: d(1), payment_status: "unpaid", trucks_needed: 1, total_tons_needed: "195.00", estimated_trips: 10 });
    ...
    dadd({ id: "demo-job-d08", contractor_id: "demo-con-3", driver_id: "demo-main", material: "Base Rock", rate: "88.00", rate_type: "hourly", truck_type: "tri_axle", status: "completed", scheduled_date: d(-31), completed_date: d(-31, 16), payment_status: "payment_received", trucks_needed: 1, total_tons_needed: "200.00", estimated_trips: 10 });
    dadd({ id: "demo-job-d09", contractor_id: "demo-con-2", driver_id: "demo-main", material: "Sand", rate: "96.00", rate_type: "hourly", truck_type: "tri_axle", status: "accepted", scheduled_date: d(8), payment_status: "unpaid", trucks_needed: 1, total_tons_needed: "185.00", estimated_trips: 9 });
    dadd({ id: "demo-job-d10", contractor_id: "demo-con-1", driver_id: "demo-main", material: "3/4 Crush", rate: "1300.00", rate_type: "flat_rate", truck_type: "tri_axle", status: "completed", scheduled_date: d(-2), completed_date: d(-2, 15), payment_status: "unpaid", trucks_needed: 1, total_tons_needed: "170.00", estimated_trips: 8 });
    ...
    for (let i = 0; i < 8; i++) {
      const c = owners[i % 3];
      jobs.push(J({ ...jDef, id: `demo-job-o${String(i + 1).padStart(2, "0")}`, contractor_id: c, driver_id: null, material: omats[i], destination_address: cAddr[c], rate: 85 + i * 2 + ".00", rate_type: i % 2 ? "flat_rate" : "hourly", truck_type: otype[i], status: "open", scheduled_date: d(3 + i), payment_status: "unpaid", trucks_needed: (i % 2) + 1, total_tons_needed: 150 + i * 15 + ".00", estimated_trips: 8 + i, urgent: i === 2 }));
    }
